...
local function registerConflictDialog()
    ZO_Dialogs_RegisterCustomDialog("EsoBRReforgedConflictDialog", {
        ...
        mainText      = { text = "|cffe014EsoBR|r e |cffe014EsoBR Reforged|r estão ativos ao mesmo tempo e causarão conflitos.\n\nQual deseja manter?" },
        buttons = {
            {
...
local function OnPlayerActivated()
    ...
    elseif Reforged.DB.isStale() then
        d("EsoBR Reforged: Banco de Dados desatualizado. Atualize em ESC → Opções → Addons → EsoBR Reforged.")
    end
end
