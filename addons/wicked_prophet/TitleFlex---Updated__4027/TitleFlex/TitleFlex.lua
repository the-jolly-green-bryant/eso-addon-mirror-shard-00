...
TitleFlex = {
  ...
  maxTitles = 100, -- updated to 100 to include 79 more titles
  ...
  accountSettings = {}, -- main settings table (contains both account and character settings)
  settings = {}, -- currently active settings (points to either account or character settings)
}
